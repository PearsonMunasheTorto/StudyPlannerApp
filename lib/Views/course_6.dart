...
class MobileApplicationDevelopment extends StatefulWidget {
  const MobileApplicationDevelopment({super.key});

  @override
  State<MobileApplicationDevelopment> createState() => _MobileApplicationDevelopmentState();
}

class _MobileApplicationDevelopmentState extends State<MobileApplicationDevelopment> {
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => DisplayDocuments(
          pdfPath: 'assets/notes/MobileApplicationDevelopment/${pdfFiles[index]}.pdf',
        ),
      ),
    );
  }
