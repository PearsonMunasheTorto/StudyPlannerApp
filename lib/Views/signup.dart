            ...
            child: Column(
              ...
              children: [
               const Padding(
                 ...
                 child: Text("create new account",style: TextStyle(color: primaryColor,fontSize: 30,fontWeight: FontWeight.bold),),
               ),

                const SizedBox(height: 20),
                InputField(hint: "Enter Your Name", icon: Icons.person, controller: fullName),
