...
class IntroToProgramming extends StatefulWidget {
  const IntroToProgramming({super.key});

  @override
  State<IntroToProgramming> createState() => _IntroToProgrammingState();
}

class _IntroToProgrammingState extends State<IntroToProgramming> {
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => DisplayDocuments(
          pdfPath: 'assets/notes/introToProgramming/${pdfFiles[index]}.pdf',
        ),
      ),
    );
  }
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              Text('Intro To Programming'.toUpperCase(),
