...
class DataCommunicationAndNetworking extends StatefulWidget {
  const DataCommunicationAndNetworking({super.key});

  @override
  State<DataCommunicationAndNetworking> createState() => _DataCommunicationAndNetworkingState();
}

class _DataCommunicationAndNetworkingState extends State<DataCommunicationAndNetworking> {
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => DisplayDocuments(
          pdfPath: 'assets/notes/dataCommunicationAndNetworking/${pdfFiles[index]}.pdf',
        ),
      ),
    );
  }
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              Text('Data Communications and Networking'.toUpperCase(),
