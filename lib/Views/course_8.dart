...
class LinearAlgebra extends StatefulWidget {
  const LinearAlgebra({super.key});

  @override
  State<LinearAlgebra> createState() => _LinearAlgebraState();
}

class _LinearAlgebraState extends State<LinearAlgebra> {
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => DisplayDocuments(
          pdfPath: 'assets/notes/linearAlgebra/${pdfFiles[index]}.pdf',
        ),
      ),
    );
  }
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              Text('Linear Algebra'.toUpperCase(),
