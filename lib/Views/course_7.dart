...
class AdvancedMathStructures extends StatefulWidget {
  const AdvancedMathStructures({super.key});

  @override
  State<AdvancedMathStructures> createState() => _AdvancedMathStructuresState();
}

class _AdvancedMathStructuresState extends State<AdvancedMathStructures> {
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => DisplayDocuments(
          pdfPath: 'assets/notes/AdvancedMathStructures/${pdfFiles[index]}.pdf',
        ),
      ),
    );
  }
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              Text('Advanced Math Structures'.toUpperCase(),
